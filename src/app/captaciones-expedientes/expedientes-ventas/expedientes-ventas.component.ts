...
@Component({
  selector: 'app-expedientes-ventas',
  templateUrl: './expedientes-ventas.component.html',
  styleUrls: ['./expedientes-ventas.component.css']
})
export class ExpedientesVentasComponent implements OnInit {
